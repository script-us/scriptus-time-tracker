...
import { IssuesData } from "../issues/IssuesList";
          ...
          <div className={styles.dateFilter}>
            ...
            <div>
              <FormControl sx={{ m: 1, minWidth: 300 }}>
                ...
                <Select labelId="demo-simple-select-autowidth-label" id="demo-simple-select-autowidth" value={personName} onChange={handleChange} autoWidth label="Age">
                  {names.map((name) => (
