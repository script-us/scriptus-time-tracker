...
const InputField = forwardRef<HTMLInputElement, PropTypes>(
  (
    { size = 'md', title, icon, error, extraText, className, inputClassName, ...props }: PropTypes,
    ref
  ) => {
    const id = useId()
        ...
        <div className="relative">
          ...
          <input
            ...
            className={clsx(
              ...
              {
                'border-red-500 text-red-900 placeholder:text-red-700 dark:border-red-500 dark:text-red-500 dark:placeholder:text-red-500':
                  error !== undefined,
                'pl-8': !!icon,
                'p-1.5': size === 'sm',
                'p-2.5': size === 'md',
          ...
          {extraText && (
            <span
              className={clsx(
                'absolute whitespace-nowrap rounded bg-field-inner font-medium text-gray-800 dark:text-gray-400',
                {
