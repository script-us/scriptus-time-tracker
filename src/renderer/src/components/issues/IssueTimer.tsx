...
const IssueTimer = forwardRef(({ issue, data: { active, time, start }, onStart, onPause, onReset, onOverrideTime, onDoneTimer, setIsPause, onAddManually }: PropTypes, ref: ForwardedRef<TimerRef>) => {
