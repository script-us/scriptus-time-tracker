        ...
        <ContextMenu
          menu={[
            ...
            [
              {
                name: formatMessage({
                  id: assignedToMe || remembered ? "issues.context-menu.pin" : "issues.context-menu.pin-and-remember",
                }),
            ...
            <div className="absolute right-2 top-2 flex items-start justify-end gap-x-1">
              {pinned && (
                <>
                  ...
                  <FontAwesomeIcon icon={faThumbTack} className="dark:text-white-600 rotate-[30deg] text-gray-300 focus:outline-none" data-tooltip-id={`tooltip-pinned-${issue?.id}`} tabIndex={-1} />
                </>
              )}
              {!assignedToMe && (
                <>
