  ...
  return (
    <>
        ...
        validationSchema={Yup.object({
          redmineURL: Yup.string()
            ...
            .matches(
              ...
              formatMessage({ id: 'settings.redmine.url.validation.valid-url' })
            ),
          redmineApiKey: Yup.string().required(
            formatMessage({ id: 'settings.redmine.api-key.validation.required' })
          )
        })}
              ...
              <div className="flex flex-col gap-y-1">
                <Fieldset legend={<FormattedMessage id="settings.general" />}>
                  <div className="flex flex-col gap-y-2">
                      ...
                      options={[
                        ...
                        ...LANGUAGES.map((lang) => {
                          ...
                          return {
                            ...
                            icon: (
                              <FlagComponent className="box-content inline-block h-3 align-[-0.125em]" />
                            ),
                            value: lang
                          }
                        })
                    ...
                    <a
                      href="https://github.com/CrawlerCode/redmine-time-tracking#supported-languages"
                      target="_blank"
                      tabIndex={-1}
                          ...
                          <p>
                            ...
                            <FormattedMessage
                              ...
                              values={{
                                link: (children) => (
                                  <a
                                    href={`${values.redmineURL}/my/account`}
                                    target="_blank"
                                    tabIndex={-1}
                        ...
                        <div className="flex items-center gap-x-2">
                          <div className="relative w-full">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() => setEditRedmineInstance(true)}
                            >
                ...
                <Fieldset legend={<FormattedMessage id="settings.style" />}>
                  <div className="flex flex-col gap-y-2">
                    <Field
                      type="checkbox"
                      name="style.stickyScroll"
                      title={formatMessage({ id: 'settings.style.sticky-scroll.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      type="checkbox"
                      name="style.groupIssuesByVersion"
                      title={formatMessage({ id: 'settings.style.group-issues-by-version.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      type="checkbox"
                      name="style.showIssuesPriority"
                      title={formatMessage({ id: 'settings.style.show-issues-priority.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      type="checkbox"
                      name="style.sortIssuesByPriority"
                      title={formatMessage({ id: 'settings.style.sort-issues-by-priority.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      type="checkbox"
                      name="style.pinTrackedIssues"
                      title={formatMessage({ id: 'settings.style.pin-tracked-issues.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      ...
                      title={formatMessage({ id: 'settings.style.show-tooltips.title' })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
      ...
      {saved && (
        <Toast
          type="success"
          message={formatMessage({ id: 'settings.settings-saved' })}
