          ...
          <>
            <Form>
              <div className="flex flex-col gap-y-1">
                <Fieldset legend={<FormattedMessage id="settings.general" />} className="setting">
                ...
                <Fieldset legend={<FormattedMessage id="settings.redmine" />} className="setting">
                  <div className="flex flex-col gap-y-2">
                    {(editRedmineInstance && (
                      <>
                        <Field
                ...
                <Fieldset legend={<FormattedMessage id="settings.features" />} className="setting">
                  <div className="flex flex-col gap-y-2">
                    <Field
                      type="checkbox"
                      ...
                      description={formatMessage({
                        id: "settings.features.auto-pause-on-switch.description",
                      })}
                      as={CheckBox}
                      disabled={true}
                    />
                    <Field
                      ...
                      description={formatMessage({
                        id: "settings.features.extended-search.description",
                      })}
                      as={CheckBox}
                      disabled={true}
                    />
                    ...
                    <Field
                      ...
                      description={formatMessage({
                        id: "settings.features.cache-comments.description",
                      })}
                      as={CheckBox}
                      disabled={true}
                    />
                ...
                <Fieldset legend={<FormattedMessage id="settings.style" />} className="setting">
                  <div className="flex flex-col gap-y-2">
                    <Field type="checkbox" name="style.stickyScroll" title={formatMessage({ id: "settings.style.sticky-scroll.title" })} as={CheckBox} disabled={true} />
                    <Field type="checkbox" name="style.groupIssuesByVersion" title={formatMessage({ id: "settings.style.group-issues-by-version.title" })} as={CheckBox} disabled={true} />
                    <Field type="checkbox" name="style.showIssuesPriority" title={formatMessage({ id: "settings.style.show-issues-priority.title" })} as={CheckBox} disabled={true} />
                    <Field type="checkbox" name="style.sortIssuesByPriority" title={formatMessage({ id: "settings.style.sort-issues-by-priority.title" })} as={CheckBox} disabled={true} />
                    <Field type="checkbox" name="style.pinTrackedIssues" title={formatMessage({ id: "settings.style.pin-tracked-issues.title" })} as={CheckBox} disabled={true} />
                    <Field type="checkbox" name="style.showTooltips" title={formatMessage({ id: "settings.style.show-tooltips.title" })} as={CheckBox} disabled={true} />
                    <Field
...
//       setManifest(manifestData as ChromeManifest)
//     }
//   }, [])
...
//   const { name, version, version_name } = manifest
...
//       <a
//         href="https://chrome.google.com/webstore/detail/redmine-time-tracking/ldcanhhkffokndenejhafhlkapflgcjg"
//         target="_blank"
//         tabIndex={-1}
...
//         size="xs"
//         as="a"
//         href="https://github.com/CrawlerCode/redmine-time-tracking/releases"
//         target="_blank"
//         tabIndex={-1}
//       >
//         <FormattedMessage
//           id="settings.info.version"
//           values={{ version: version_name || version }}
//         />
//       </Button>

//       <a
//         href="https://github.com/CrawlerCode/redmine-time-tracking/issues"
//         target="_blank"
//         tabIndex={-1}
